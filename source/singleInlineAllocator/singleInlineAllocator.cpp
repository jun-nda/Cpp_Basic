...
using engine::SingleInlineAllocator;
int main( ){
	SingleInlineAllocator<64> allocator;
	allocator.allocateInternal(120);


	SingleInlineAllocator<64> allocator2;
	allocator2.allocateInternal(120);
